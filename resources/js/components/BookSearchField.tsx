...
interface BookSearchFieldProps {
    ...
    setShowBookDropdown: (show: boolean) => void;
    filteredBooks: Book[];
...
const BookSearchField: React.FC<BookSearchFieldProps> = ({
    bookSearch,
    setBookSearch,
    selectedBook,
    showBookDropdown,
    ...
    return (
        <div className="relative">
            <label className="block text-sm font-medium text-gray-300 mb-2">
                ...
                {action === 'return' && (
                    <span className="text-xs text-gray-500 ml-2">(Only borrowed books shown)</span>
                )}
            </label>
